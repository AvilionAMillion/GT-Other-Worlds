...
recipes.remove(<gregtech:meta_item_1:129>);
recipes.remove(<gregtech:meta_item_1:174>);
recipes.remove(<gregtech:meta_item_1:144>);
recipes.remove(<gregtech:meta_item_1:159>);
recipes.remove(<gregtech:meta_item_1:189>);
recipes.remove(<gregtech:meta_item_1:219>);
recipes.remove(<gregtech:meta_item_1:234>);
recipes.remove(<gregtech:meta_item_1:204>);
