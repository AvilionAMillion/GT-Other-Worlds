...
RecipeBuilder.get("farmer")
  .setShapeless([<pyrotech:material:4>, <gregtech:meta_item_1:348>])
  .addOutput(<pyrotech:material:9>)
  .create();
# Unfired Brick
RecipeBuilder.get("farmer")
  .setShapeless([<minecraft:clay_ball>, <gregtech:meta_item_1:348>])
  .addOutput(<pyrotech:material:24>)
  .create();
# Unfired Seared Brick
RecipeBuilder.get("farmer")
  .setShapeless([<tconstruct:soil>, <gregtech:meta_item_1:348>])
